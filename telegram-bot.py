...
# url = "https://domo-dev.profintel.ru/tg-bot/domo.domofon/urlsOnType?tenant_id=22054"
#
# payload = json.dumps({
#   "intercoms_id": [
#     20
...
def CreateKeyboard(text, Dict, message):
